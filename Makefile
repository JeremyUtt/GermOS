...
$(BUILD_DIR)/size.o: $(OBJS)
	...
	@cat $(BUILD_DIR)/OS1.bin $(SRC_DIR)/other/zeros.bin > bin/OS.bin
...
bin/OS.bin : $(BUILD_DIR)/OS.o $(SRC_DIR)/other/zeros.bin
	@objcopy -O binary $(BUILD_DIR)/OS.o $(BUILD_DIR)/OS1.bin
	@printf "%b" "\033[0;36m\e0OBJCOPY $< \033[0m\n"
	@cat $(BUILD_DIR)/OS1.bin $(SRC_DIR)/other/zeros.bin > $@
