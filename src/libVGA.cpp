...
static void writeMemory(uint32_t address, uint8_t* data, uint32_t size) {
    for (uint32_t i = 0; i < size; ++i) {
        *((volatile uint8_t*)(address + i)) = data[i];
    }
}

void wmem(uint32_t address, uint8_t* data, uint32_t size) {
...
static void write_font(uint8_t* buf, uint32_t font_height) {
    ...
    /* write font 0 */
    for (i = 0; i < 256; i++) {
        uint32_t address = (get_fb_seg() << 4) + 16384u * 0 + i * 32;
        writeMemory(address, buf, font_height);
        buf += font_height;
    }
#if 0
    /* write font 1 */
...
8X8 AND 8X16 FONTS
*****************************************************************************/
static uint8_t g_8x8_font[2048] = {};

static uint8_t g_8x16_font[4096] = {,
                                    ...
                                    ,
...
void read_regs(uint8_t* regs) {
    ...
    *regs = inb(VgaRegisters::VGA_MISC_READ);
    regs++;
    /* read SEQUENCER regs */
...
void set_text_mode(int hi_res) {
    ...
    if (hi_res) {
        write_regs(VgaModes::g_90x60_text);
        cols = 90;
        rows = 60;
        ht = 8;
    } else {
        write_regs(VgaModes::g_80x25_text);
        cols = 80;
        rows = 25;
        ht = 16;
    }
    /* set font */
    if (ht >= 16)
        FontManagement::write_font(FontManagement::g_8x16_font, 16);
    else
        FontManagement::write_font(FontManagement::g_8x8_font, 8);
